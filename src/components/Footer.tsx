            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <Link 
                    to={link.path} 
                    className="flex items-center gap-2 text-gray-300 hover:text-white transition-all duration-300 hover:translate-x-1 group"
                  >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-300">+971 55 491 2339</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-300">info@easyset.ae</p>
                </div>
              </a>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link to="/sitemap.xml" className="text-gray-400 hover:text-white transition">
                Sitemap
              </Link>
            </div>
          </div>
